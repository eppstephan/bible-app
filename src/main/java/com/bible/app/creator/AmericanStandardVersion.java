...
public class AmericanStandardVersion extends Bible {
	...
	public void readBible() throws IOException {
		...
		try (InputStream inputStream = getClass().getResourceAsStream("/AmericanStandardVersion.txt");
	...
	public void readIgnore() throws IOException {
		...
		try (InputStream inputStream = getClass().getResourceAsStream("/ignore-Eng.txt");
				BufferedReader br = new BufferedReader(new InputStreamReader(inputStream))) {
			String line;
			while ((line = br.readLine()) != null) {
